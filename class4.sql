DROP DATABASE IF EXISTS class4;
...
CREATE TABLE customers (
    ...
    sales_rep_employee_number VARCHAR(30) NOT NULL,
    credit_limit INT
);
...
ALTER TABLE employees MODIFY first_name VARCHAR(50) NOT NULL DEFAULT '';
...
-- escape character
SELECT * FROM customers WHERE fk_sales_employee_number LIKE '%\_2%';
